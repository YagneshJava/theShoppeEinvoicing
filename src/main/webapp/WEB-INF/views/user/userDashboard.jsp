...
<body id="page-top">
    ...
    <script src="${pageContext.request.contextPath}/app-assets/js/demo/chart-area-demo.js"></script>
    <script src="${pageContext.request.contextPath}/app-assets/js/demo/chart-pie-demo.js"></script>
