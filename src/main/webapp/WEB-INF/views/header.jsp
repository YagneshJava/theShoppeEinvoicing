					...
					<div id="kt_header" class="header header-fixed bg-color d-none">
							...
							<div class="container-fluid d-flex align-items-center justify-content-end justify-content-lg-between flex-wrap">
								...
								<div class="header-menu-wrapper header-menu-wrapper-left py-lg-2" id="kt_header_menu_wrapper">
									...
									<div id="kt_header_menu" class="header-menu header-menu-mobile header-menu-layout-default">
										<img alt="" src="assets/media/logos/e-pharma-header-logo.png" width="180">
									</div>
									<!--end::Menu-->
								</div>
								<!--end::Menu Wrapper-->
								<!--begin::Toolbar-->
								<div class="d-flex align-items-center py-3" style="opacity: 0.7;">
									<a href="profileCompanyDetailsPage" class="menu-link">
										<i class="icon-xl mr-4 fas fa-user-circle"></i>
									</a>
									<a href="#" id="" data-toggle="tooltip" data-placement="right" data-container="body" data-boundary="window" title="" class="menu-link" data-original-title="">
										<i class="icon-xl ml-1 mr-4 fas fa-bell ring"></i>
										<span class="label label-sm label-danger  label-rounded font-weight-bolder position-absolute top-0 mt-4" id="" style="margin-left: -22px;">1</span>
									</a>
									<a href="javascript:void(0)" onclick="logout()" class="menu-link menu-toggle">
										<i class="icon-xl text-danger fas fa-power-off"></i>
									</a>
								</div>
								<!--end::Toolbar-->
							</div>
